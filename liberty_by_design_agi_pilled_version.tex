...
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 1} & {\sffamily\itshape pg.~\pageref{what-do-we-want-from-our-machines-and-governance-}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape What do we want from our machines and governance?} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 2} & {\sffamily\itshape pg.~\pageref{the-end-of-implicit-guardrails}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The end of implicit guardrails} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 3} & {\sffamily\itshape pg.~\pageref{a-simple-path-to-tyranny}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape A simple path to tyranny} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 4} & {\sffamily\itshape pg.~\pageref{the-prompt-of-power}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The Prompt of Power} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 5} & {\sffamily\itshape pg.~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Rapid fire governance — designing upgrades to democracy} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 6} & {\sffamily\itshape pg.~\pageref{superchecks-and-superbalances}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Superchecks and superbalances} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 7} & {\sffamily\itshape pg.~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The realpolitik AI — forging a new political alliance} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 8} & {\sffamily\itshape pg.~\pageref{an-exponential--if-you-can-keep-it}} \\[0.3cm]
\nopagebreak
