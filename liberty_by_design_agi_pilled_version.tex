...
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 1} & {\headingfont\itshape pg.~\pageref{what-do-we-want-from-our-machines-and-governance-}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape What do we want from our machines and governance?} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 2} & {\headingfont\itshape pg.~\pageref{the-end-of-implicit-guardrails}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The end of implicit guardrails} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 3} & {\headingfont\itshape pg.~\pageref{a-simple-path-to-tyranny}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape A simple path to tyranny} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 4} & {\headingfont\itshape pg.~\pageref{the-prompt-of-power}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The Prompt of Power} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 5} & {\headingfont\itshape pg.~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape Rapid fire governance — designing upgrades to democracy} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 6} & {\headingfont\itshape pg.~\pageref{superchecks-and-superbalances}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape Superchecks and superbalances} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 7} & {\headingfont\itshape pg.~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The realpolitik AI — forging a new political alliance} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 8} & {\headingfont\itshape pg.~\pageref{an-exponential--if-you-can-keep-it}} \\[0.3cm]
\nopagebreak
...
\textbf{Or leave comments on the draft here: }\textbf{https://tinyurl.com/liberty-by-design}
...
\vspace{1.1cm}
\section*{Chapter 6: Superchecks and superbalances\textbf{}}
\vspace{0.3cm}
