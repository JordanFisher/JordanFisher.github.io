...
% Preserve sans-serif for titles and headings
...
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 1} & {\headingfont\itshape pg.~\pageref{why-ai-is-accelerating--and-why-we-have-little-time-left}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape Why AI is accelerating, and why we have little time left} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 2} & {\headingfont\itshape pg.~\pageref{what-do-we-want-from-our-machines-and-governance-}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape What do we want from our machines and governance?} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 3} & {\headingfont\itshape pg.~\pageref{the-end-of-implicit-guardrails}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The end of implicit guardrails} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 4} & {\headingfont\itshape pg.~\pageref{a-simple-path-to-tyranny}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape A simple path to tyranny} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 5} & {\headingfont\itshape pg.~\pageref{the-prompt-of-power}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The Prompt of Power} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 6} & {\headingfont\itshape pg.~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape Rapid fire governance — designing upgrades to democracy} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 7} & {\headingfont\itshape pg.~\pageref{superchecks-and-superbalances}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape Superchecks and superbalances} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 8} & {\headingfont\itshape pg.~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape The realpolitik AI — forging a new political alliance} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 9} & {\headingfont\itshape pg.~\pageref{an-exponential--if-you-can-keep-it}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape An exponential, if you can keep it} \\
\noalign{\vspace{2em}}
\nopagebreak
{\headingfont\itshape Chapter 10} & {\headingfont\itshape pg.~\pageref{a-crash-course-on-ai}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\headingfont\itshape A Crash Course on AI} \\
\end{longtable}
\vspace{0.5cm}
\vspace{0.5em}
...
\vspace*{1.5cm}
\section*{\huge Welcome to the curve}
\vspace{0.7cm}
...
\begin{itemize}
\item Machines have now reached human intelligence in many domains, and will soon surpass humans in most others.
...
\item Our modern democracies took thousands of years of trial and error to arrive at and are still a work in progress.
\item What makes for good governances of a society depends strongly on the details of its members: us humans.
\end{itemize}
...
\item As those details change, many of the implicit guardrails we rely upon for checks and balances on power will be swept away.
\item For example, institutions often avoid illegal actions because their human employees might refuse to accept unethical tasks. Or, even if employees comply with illegal requests, human whistleblowers within the organization can alert the public to any abuses. Once an institution is fully automated, these restraints won't exist.
...
\item If we don't change course, human-powered tyranny may be the default outcome of a machine-powered world.
\item It will be increasingly hard for us to resist this tyranny the later we act. We must evolve our governance \textit{before} strong AI arrives, or we may not have any power left as citizens to fix it \textit{after}.
\end{itemize}
...
\begin{itemize}
\item The incentives around AI are complex and will pull different countries, corporations, and societies in many different directions.
\item We can't predict how all those forces will play out, but we can think through different scenarios.
\item Here we'll explore a short story of what may happen if we keep walking down our current path, and how it may lead to an unrecoverable concentration of power and the end of liberty.
...
\item With AI, both the legislature and judiciary can scale their oversight ability, while still keeping humans at the helm.
\end{itemize}


\vspace{1.1cm}
\section*{Chapter 7: Superchecks and superbalances\textbf{}}
\vspace{0.3cm}

\begin{itemize}
\item We should think through and imagine how the design of our governance may fail, to better design a more resilient system.
...
\item A positive future will surely play out differently than we expect, even if things go well. But setting a vision of what good could look like is important so we know what we're fighting for.
...
\begin{itemize}
\item Intelligence is the most transformative power the world has ever seen. Until today, that power has been a human power alone. Now, with AI, we are on the precipice of unleashing that power a thousand fold, and it won't be human.
\item The force of multiplied intelligence rewrites the rules of our world. That force may deliver near infinite abundance, or total ruin.
\item We are on the exponential now. AI is the defining event of our lifetime, but the outcome is not yet written. We all own the conversation for what we want the future to be.
\item If we don't together contribute to this debate ---all of us--- then the most important decisions of the future of our world will be made without us.
\end{itemize}
...
\clearpage
\phantomsection\label{why-ai-is-accelerating--and-why-we-have-little-time-left}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 1}
\vspace{-0.5cm}
\section*{\huge Why AI is accelerating, and why we have little time left}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{what-do-we-want-from-our-machines-and-governance-}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 2}
\vspace{-0.5cm}
\section*{\huge What do we want from our machines and governance?}
\vspace{0.7cm}
...
Then the question remains: which human or group of humans? To which other humans are those humans accountable and by what means? Where does the \textit{d\={e}mos} in democracy sit?
...
\clearpage
\phantomsection\label{the-end-of-implicit-guardrails}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 3}
\vspace{-0.5cm}
\section*{\huge The end of \sout{implicit} guardrails}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{a-simple-path-to-tyranny}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 4}
\vspace{-0.5cm}
\section*{\huge A simple path to tyranny}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{the-prompt-of-power}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 5}
\vspace{-0.5cm}
\section*{\huge The Prompt of Power}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{rapid-fire-governance---designing-upgrades-to-democracy}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 6}
\vspace{-0.5cm}
\section*{\huge Rapid fire governance --- designing upgrades to democracy}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{superchecks-and-superbalances}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 7}
\vspace{-0.5cm}
\section*{\huge Superchecks and superbalances}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{the-realpolitik-ai---forging-a-new-political-alliance}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 8}
\vspace{-0.5cm}
\section*{\huge The realpolitik AI --- forging a new political alliance}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{an-exponential--if-you-can-keep-it}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 9}
\vspace{-0.5cm}
\section*{\huge An exponential, if you can keep it}
\vspace{0.7cm}
...
\clearpage
\phantomsection\label{a-crash-course-on-ai}
\vspace*{1.5cm}
{\headingfont\itshape\small Chapter 10}
\vspace{-0.5cm}
\section*{\huge A Crash Course on AI}
\vspace{0.7cm}
