...
\usepackage[
  ...
  pdftitle={Liberty by Design: Governing a Human-Machine Society},
]{hyperref}
...
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 1} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Why AI is accelerating, and why we have little time left} \\
{} & {\sffamily\itshape pg.~\pageref{why-ai-is-accelerating--and-why-we-have-little-time-left}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 2} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape What do we want from our machines and governance?} \\
{} & {\sffamily\itshape pg.~\pageref{what-do-we-want-from-our-machines-and-governance-}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 3} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The end of implicit guardrails} \\
{} & {\sffamily\itshape pg.~\pageref{the-end-of-implicit-guardrails}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 4} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape A simple path to tyranny} \\
{} & {\sffamily\itshape pg.~\pageref{a-simple-path-to-tyranny}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 5} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The Prompt of Power} \\
{} & {\sffamily\itshape pg.~\pageref{the-prompt-of-power}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 6} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Rapid fire governance — designing upgrades to democracy} \\
{} & {\sffamily\itshape pg.~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 7} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Superchecks and superbalances} \\
{} & {\sffamily\itshape pg.~\pageref{superchecks-and-superbalances}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 8} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The realpolitik AI — forging a new political alliance} \\
{} & {\sffamily\itshape pg.~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 9} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape An exponential, if you can keep it} \\
{} & {\sffamily\itshape pg.~\pageref{an-exponential--if-you-can-keep-it}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 10} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape A Crash Course on AI} \\
{} & {\sffamily\itshape pg.~\pageref{a-crash-course-on-ai}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 11} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Concrete — near term actions and proposals} \\
{} & {\sffamily\itshape pg.~\pageref{concrete---near-term-actions-and-proposals}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 12} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Don’t be silly} \\
{} & {\sffamily\itshape pg.~\pageref{don-t-be-silly}} \\[0.3cm]
\noalign{\vspace{2em}}
{\sffamily\itshape Chapter 13} & {} \\[0.3cm]
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Complexity and Iterative Design} \\
{} & {\sffamily\itshape pg.~\pageref{complexity-and-iterative-design}} \\[0.3cm]
\end{longtable}
\vspace{0.5cm}
\vspace{0.5em}
...
\clearpage
\vspace*{1.5cm}
\section*{\huge A new user has joined the chat}
\vspace{0.7cm}
...
\item If we understand why this progress is accelerating, we will be able to better design how we want to integrate it into human society
\end{itemize}
...
\item As those details change, all of the implicit guardrails we rely upon for checks and balances will be swept away
...
\begin{itemize}
\item Automation will increasingly consolidate power into fewer and fewer hands, and the guardrails preventing abuse of that power will continue to become obsolete
\item Gradually, and then all at once, we will enter a world where checks on power are impotent
\item If we don't change course, tyranny is the default outcome of AI. And it will be increasingly hard for us to resist it the later we act
...
\item Humans alone won't be able to oversee leaders empowered by AI. As is stands, whoever controls AI will control nearly everything
\end{itemize}
...
\item If we only automate our government and military, we will hand so much power over to our government that we may never be free again
...
\item We are on the exponential now. Where will it take us? \textit{We} must decide
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 1}
\vspace{-0.5cm}
\section*{\huge Why AI is accelerating, and why we have little time left}\label{why-ai-is-accelerating--and-why-we-have-little-time-left}
\vspace{0.7cm}
...
Isn't this just another new technology? Is there really so much more progress in front of us that society is in danger? That our lives literally are in danger?
...
\begin{itemize}
\item AIs know more than any human alive, by many orders of magnitude. In terms of pure question answering ability, they're now outpacing even most professionals. I hold a PhD in computational fluid dynamics, and I can't hold my own against AI even in this narrow domain I spent years mastering 
...
\begin{itemize}
\item Let's take writing code as a concrete example
...
\item Even that we often don't know how to do, so we often \textit{train an AI to figure out how to give feedback to itself}. This may sound circuitous, but it's similar to how a coach can help a world class athlete becomes a better athlete, even if the coach themself isn't and never was world class
\end{itemize}
...
\item The hard task for an AI is getting close to human performance at all. This requires learning abstract concepts about the domain and understanding relationships between those concepts
\item Humans are excellent at this process of abstracting, and are still better than AIs at doing it quickly
\item However, once an AI has learned the right concepts, it has a massive advantage over humans for what comes next: practicing. An AI can run millions of copies of itself, at thousands of time human speeds, allowing it to practice tasks millions of times more thoroughly than any human
...
\item However, we repeatedly see that this intermediate level of skill is fleeting --- the period where the AI is similar but not better to most humans is often a very short period of time
\end{itemize}
...
\item Today we're also seeing strong AI competence in medicine, law, accounting, project management, and a myriad other types of knowledge work. We should expect to see superhuman performance in these areas in the next few years as we let the AI practice these roles as well
...
\item And, as the AI that the AIs create gets better, the pace of improving AI will increase further. And so on and on
\item When improvements create the conditions for further improvements, you end up with a recursively improving loop. What we call ``recursive self-improvement''
...
\item The motivation levels are high. Unlike other highly lucrative fields that attract STEM majors --- like finance --- AI is a fascinating scientific field that involves trying to understand the nature of intelligence itself. Even before working on AI paid well, many scientists were passionate about solving intelligence
...
\item Today, you can only pay for so much labor before you run out of qualified people, especially for challenging, technical projects like AI or scientific research
...
For example, OpenAI was founded as a non-profit, with a mission to help superintelligence benefit all humanity. Today, however, as their valuation rapidly exceeds \$100 billion, they are trying to convert to a for-profit enterprise and explicitly abandon their original humanitarian mission.

Google historically abstained from assisting the US military. In April 2025, Google announced that not only will they begin providing their frontier AI systems to the government, they will deploy them for Top Secret operations into air gapped data centers the government controls, which will prevent any oversight of their use. Even prior to this, DOGE had begun deploying AI in the federal government to accelerate the automation of agencies.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 2}
\vspace{-0.5cm}
\section*{\huge What do we want from our machines and governance?}\label{what-do-we-want-from-our-machines-and-governance-}
\vspace{0.7cm}
...
The question of how to govern machine is thus a continuation of the question of how to govern ourselves. What social compact must we craft so that an aggregate society of diverse intelligences is a net good for those intelligences, and a net good for us in particular.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 3}
\vspace{-0.5cm}
\section*{\huge The end of \sout{implicit} guardrails}\label{the-end-of-implicit-guardrails}
\vspace{0.7cm}
...
\item At the international level this helps balance power between nations. For examples, this has allowed lagging nations to more rapidly industrialize.
...
\item Compliance to the group or cartel becomes exponentially harder as the size of the conspiracy grows. Not true with AI, where compliance (alignment) may be complete.
\end{itemize}
...
\item And the implicit guardrails within media companies help prevent the worst abuses
...
\vspace{1.1cm}
\section*{Social media spreads knowledge that mainstream may not }
\vspace{0.3cm}
...
\item Today, to properly feed a society we need a well kept human economy, which requires many more human affordances by necessity. This is one reason why capitalism and liberty have often gone hand in hand.
\end{itemize}
...
\item But tomorrow, a strong enough technical leader may be able to directly pair with an AGI or superintelligence without any additional assistance from employees
\item In order to improve security, some AI labs are already isolating which members have access to the next frontier, so it wouldn't even raise alarm bells for an employee to no longer have access and to be unaware of who does
...
\begin{itemize}
\item Authoritarians can't simply kill all their citizens today, or their economy and warmaking ability would be gutted. In fact, they are incentivized to create a rich economy, in order to have doctors, entertainment, and luxuries.
\item The Khmer Rouge killed nearly 25\% of their own population, crippling their own warmaking ability. They ended up obliterated by a Vietnamese invasion.
...
AI has the potential for tremendous upside, the point of this exercise isn't to paint AI in a negative light. Instead, it's to highlight that AI will reshape our society at every level, and that will require rethinking the way every level works. Our society is saturated with implicit guardrails. If we removed them all without replacing them with new guardrails, society would almost surely collapse. Moreover, the explicit guardrails we do have today ---our laws and explicit institutions--- have been designed with our existing implicit guardrails in mind. They're complimentary.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 4}
\vspace{-0.5cm}
\section*{\huge A simple path to tyranny}\label{a-simple-path-to-tyranny}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 5}
\vspace{-0.5cm}
\section*{\huge The Prompt of Power}\label{the-prompt-of-power}
\vspace{0.7cm}
...
We thought the government would step in. Maybe they could help slow down the race. Maybe they help secure the labs. Maybe they could stop our geopolitical rivals from stealing our intellectual work and building their own powerful AI.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 6}
\vspace{-0.5cm}
\section*{\huge Rapid fire governance --- designing upgrades to democracy}\label{rapid-fire-governance---designing-upgrades-to-democracy}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 7}
\vspace{-0.5cm}
\section*{\huge Superchecks and superbalances}\label{superchecks-and-superbalances}
\vspace{0.7cm}
...
\textit{We need a different tact}, he thought. \textit{If only I had an Executive AI that did whatever I asked it to do.} 
...
\item If the AI was fully open source, and the training data and training process was fully audited and independently replicated by Congress.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 8}
\vspace{-0.5cm}
\section*{\huge The realpolitik AI --- forging a new political alliance}\label{the-realpolitik-ai---forging-a-new-political-alliance}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 9}
\vspace{-0.5cm}
\section*{\huge An exponential, if you can keep it}\label{an-exponential--if-you-can-keep-it}
\vspace{0.7cm}
...
Speak your mind. Debate with your friends. Educate yourself and others on the rapid pace of change.  Fight for good policies and standards, whether at work, for government, or in your community. Be critical of the motives of every leader, even if you like them --- perhaps especially if you like them. But most importantly, join the conversation. This is our future to design.

And when the weight of the future weighs on you, remember: We've achieved greater things against worse odds.

On July 16, 1945 we detonated the first nuclear bomb --- the first super weapon. The world had never seen a weapon of mass destruction before. The implication for world security was startling. In the decades that followed, it was the civil conversation that mattered most. It was pervasive, and it provided the intellectual foundation and social pressure to push the world away from nuclear Armageddon. It didn't have to go so well, but it did, because of the collective force of humanity. Norms were set, treaties were signed, wars were averted.

Most important of all, we talked about the problem. At our family dinners, with friends, at rallies, and through protests. We forced the conversation, and the media and politicians centered themselves and their messaging around it in response. Ultimately that gave us the chance for our vote to matter. But our influence on cultural norms were just as important. Through that shared human culture we influenced our geopolitical adversaries and the world writ large. We saw through a Cold War where the wrong side of a decision was utter annihilation.
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 10}
\vspace{-0.5cm}
\section*{\huge A Crash Course on AI}\label{a-crash-course-on-ai}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 11}
\vspace{-0.5cm}
\section*{\huge Concrete --- near term actions and proposals}\label{concrete---near-term-actions-and-proposals}
\vspace{0.7cm}
...
The future is abundance and Dyson spheres and universal peace and love for all mankind.
...
\vspace{1.1cm}
\section*{Near-term goals to fortify democracy}
\vspace{0.3cm}

\begin{itemize}
\item We must win the AI arms race against authoritarian regimes, if it indeed comes down to a race
\item We must simultaneously deescalate that race, and make room for collaboration and peace. Both to give us time to align the machines to humanity, and also to avert potential war with each other. AI has the potential to usher in a new golden age for humanity. We should hope that the golden age is truly for all humanity.
\item We must strengthen our domestic policies to let us move faster, including investments in energy, chips, and AI
\item That means our strongest corporations must become stronger, and our central government must become stronger too
\item We must simultaneously empower every citizen to be a stronger check on these corporations and the central government. And we must strengthen the wider economy of small businesses and startups
\item We need near-term policies that can be implemented today, that set the groundwork for superchecks and superbalances to evolve tomorrow
\end{itemize}
...
\vspace{1.1cm}
\section*{AI Principles}
\vspace{0.3cm}

\begin{itemize}
\item We don't know exactly how to control AI, but we do know how to partially guide it. \textit{Where }we guide it to should be a set of principles that lifts up humanity
\item Today, these principles are chosen by the companies building the AIs. Since we are rapidly deploying these AIs to be our new workforce, at the very least these principles should be fully transparent to society
\item If there are sensitive aspects to these principles that can't be made public --- for example, relating to how to handle top secret information or matters of national security --- these aspects should be reviewed by independent auditors, or by Congress itself
\item This would start purely as a written commitment from AI labs. The only enforcement would come from internal lab employees that care about holding their employer accountable
\item Written commitments won't be enough as we reach full automation. The employees of the AI labs themselves will become automated soon, thus removing this implicit enforcement mechanism. But it's still a good initial stepping stone
\end{itemize}
...
\vspace{1.1cm}
\section*{A personal agent works for you}
\vspace{0.3cm}

\begin{itemize}
\item Imagine if you hired a personal assistant, but secretly they worked for a large advertising company. The assistant does so much for you behind the scenes that you don't have time to review everything they do
\item Now that they've gained your trust, they subtly make decisions that benefit the advertisers paying their parent company. The hotels they book for you, the airlines they prefer, the restaurants they suggest, the news articles they summarize for you to read over your morning coffee
\item Worse, imagine hiring a lawyer to represent you, but they secretly push for outcomes that align with one of their business partners
\item These are plain conflicts of interest that we don't tolerate for humans that assist us. We need the same standard for AI
\item Any AI performing actions on behalf of a user must disclose conflicts. And these conflicts cannot be hidden away in voluminous terms of service. They need to be escalated to the user to see in the moment, when actions or recommendations are being made.
\end{itemize}

\vspace{1.1cm}
\section*{AI Vetting for Federal Use}
\vspace{0.3cm}

\begin{itemize}
\item Federal agents must go through extensive background checks and interviews to get top secret clearance
\item AI will soon do the equivalent work of millions of federal employees. Google recently announced in early 2025 that they are deploying their AI to top secret environments
\item It's both economical and wise to apply at least 10 or 100 times the vetting for a single AI as we do for a single federal employee
\item The vetting process should be a publicly visible set of tests and evaluations. This will give us confidence that every AI is being evaluated evenly. The Executive should design the process, and Congress should be responsible for signing off on it, as well as ensuring that the process is being applied fairly
\item This mirrors the process the Executive and Legislature follow today for key federal appointments
\end{itemize}
...
\vspace{1.1cm}
\section*{Domestic capacity}
\vspace{0.3cm}

\begin{itemize}
\item Currently we're reliant on Taiwan's TSMC for all of our AI accelerators
\item Both the Biden and second Trump administrations have been vocal about growing our domestic chip capacity and our domestic energy supply to power our data centers
\item But we need much more than this
\item With robots rapidly maturing, the future of industry will be determined by how quickly a nation can scale their robotics supply chain. The most important thing robots can build is more robots. Once robotics matures, it can be used to exponentially increase robotic manufacturing capacity
\item We need to stimulate our robotics industry, not just our chips industry
\item Because robotics is lagging behind general AI, the most important ingredient is talent and expertise
\item Currently the best robotics research is happening in China. We should be aggressively recruiting this talent, and all other AI and hardware talent, and bringing them to the US. Just like the space race of the 20th century, the quickest path to success is to leverage your adversaries best intelligences
\item We also need to streamline permitting for new power plants and data centers at scale, preparing for the near future where we will 10x and then 100x our development capacity. There's plenty of sunny, uninhabited land to build in the US. In France, there is abundant nuclear energy, although land for data centers is more challenging to find
\end{itemize}

\vspace{1.1cm}
\section*{Allied capacity}
\vspace{0.3cm}

\begin{itemize}
\item Data centers and power plants are the new aircraft carriers. The near future will be won by these assets, not with traditional weapons. Not even by new-age drones
\item Just like we are asking Europe to pay their fair share of NATO military expenses, we must encourage Europe to invest in the most important strategic asset of tomorrow's defense: massive data centers and the power plants that power them
\item The most limited aspect of the AI supply chain comes from the EUV machine used to etch AI accelerator chips. This machine can only be built by one company: ASML, a Dutch company. It's widely believed it would take \textasciitilde{}10 years for either the US or China to replicate the ASML EUV technology
\item That makes Europe a default key player in the most important race in history
\item The West should strive for a mutual trade agreement that emphasizes what's most important about the future: aggregate compute capacity across democracies. This is the modern equivalent of number of aircraft carriers, and will measure the true power of the free world
\end{itemize}

\vspace{1.1cm}
\section*{The specific AI itself may not matter}
\vspace{0.3cm}

\begin{itemize}
\item Many policy proposals focus on securing the weights or source code of an AI model, so as to prevent foreign adversaries from being able to easily copy the AI
\item However, we've now seen that China is able to build their own AI from scratch, and are only a few months behind the frontier US labs
\item In a world where building AI is easy, the strategic advantage lies solely with compute capacity and energy supply, neither of which can be stolen
\item While securing weights is still important, policies that aim to secure weights should be carefully weighed against ways they may slow down other critical developments
\item For example, if we're overly cautious about preventing foreign spies from infiltrating our labs, we may miss out on key talent that pushes forward our industrial capacity
\end{itemize}

\vspace{1.1cm}
\section*{Export controls and the industrial race}
\vspace{0.3cm}

\begin{itemize}
\item If chips really are the most important strategic input to the future, then we need to take seriously where our chips go and who is making them
\item NVIDIA, TSMC, and ASML are effectively arms dealers, building the most important strategic assets of tomorrow
\item As early as 2022, the Biden administration recognized that our highest performing AI GPUs were critical to winning the AI race. Because of this, they enacted export bans preventing NVIDIA from selling them to China
\item In the first half of 2025, we may be entering into a full trade war with China. The details for strategic industrial capacity are complicated
\item Nearly 90\% of rare earth processing happens in China, elements that are critical to semiconductor manufacturing. In early April 2025, China enacted a global ban on exporting rare earth minerals
\item At the same time, the Western alliance has ASML, TSMC, and NVIDIA --- the most important technology providers for delivering cutting edge chips
\item China is racing to replace their dependence on external semiconductor technology providers. China's Huawei just announced --- also in April 2025 --- that they have built an AI data center that is beginning to approach the strength of those built by NVIDIA. While it's still \textasciitilde{}3x less efficient, that differential can easily be overcome by sheer industrial scale, something China has in spades
\item Meanwhile, the West is not yet racing to replace their dependence on Chinese rare earth minerals, and the lead time for creating new mining capacity can be several years
\end{itemize}

\vspace{1.1cm}
\section*{The allied alliance}
\vspace{0.3cm}

\begin{itemize}
\item Building US industrial capacity to exceed China's is strategically essential. However, the timelines to achieve this are too long for it to be the West's only strategy
\item The race to superintelligence may be over in just a few years, less time than it often takes to spin up a single new rare earth mine
\item The US must also quickly revitalize partnerships with the rest of free world with a surgical focus on semiconductor manufacturing, energy production, and robotics
\end{itemize}

At the same time, we need to create a path toward disescalation and peace.

\vspace{1.1cm}
\section*{The shared future}
\vspace{0.3cm}

\begin{itemize}
\item We should seek international coordination on principles all AIs should follow
\item We should ensure all nations are pursuing AI safety research and responsible deployments
\item Safety research should be done in the open, with international cooperation
\item We should begin exploring how to deploy AIs in a trustless setting to enable joint monitoring of treaty compliance
\end{itemize}

As we seek international collaboration, we also need to ensure our own domestic use of AI upholds the constitution.

\vspace{1.1cm}
\section*{Government transparency and AI audits of AI}
\vspace{0.3cm}

\begin{itemize}
\item Automation will remove our implicit guardrails. Discovering malfeasance will become increasingly difficult
\item How can a human Inspector General hope to keep up with overseeing a rapidly automating federal agency?
\item As we automate our federal agencies, we must insert automated oversight as well
\item We already require record keeping for federal employees. This allows for future audits of federal actions, a key ingredient in Congress's and the Judiciary's ability to provide checks on the Executive
\item Similarly, all AI-driven analyses actions taken inside a federal agency should be logged and made available to Congress
\item We might hope to have similar requirements in the public sector, but we need to be careful that these requirements don't further the concentration of power in government
\end{itemize}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 12}
\vspace{-0.5cm}
\section*{\huge Don't be silly}\label{don-t-be-silly}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\sffamily\itshape\small Chapter 13}
\vspace{-0.5cm}
\section*{\huge Complexity and Iterative Design}\label{complexity-and-iterative-design}
\vspace{0.7cm}
