...
% Title configuration
\title{Liberty by Design: Governing a Human-Machine Society}
\author{}
\date{}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 1:}}

\section*{Why AI is accelerating, and why we have little time left}\label{why-ai-is-accelerating--and-why-we-have-little-time-left}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 2:}}

\section*{What do we want from our machines and governance?}\label{what-do-we-want-from-our-machines-and-governance-}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 3:}}

\section*{The end of \sout{implicit} guardrails}\label{the-end-of-implicit-guardrails}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 4:}}

\section*{A simple path to tyranny}\label{a-simple-path-to-tyranny}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 6:}}

\section*{Rapid fire governance --- designing upgrades to democracy}\label{rapid-fire-governance---designing-upgrades-to-democracy}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 7:}}

\section*{Superchecks and superbalances}\label{superchecks-and-superbalances}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 8:}}

\section*{The realpolitik AI --- forging a new political alliance}\label{the-realpolitik-ai---forging-a-new-political-alliance}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
{\small\textit{Chapter 12:}}

\section*{Complexity and Iterative Design}\label{complexity-and-iterative-design}
\vspace{0.7cm}
