...
\begin{quote}
\textit{Well, this is it. I wrote a big ass post about my thoughts on how to improve AI governance. I called it a Tiny Book so you might be tricked into thinking it’s a quick read}
\end{quote}

No one wants to read 50 pages on governance. This book is built to be read in parts, or just pick the parts you’re interested in.
...
Only have 30 seconds? Read the TL;DR
...
The sun emits almost a million, trillion gigawatts of power. 3.8 × 10\textasciicircum{}26 watts. Almost a billion gigawatts for every human alive today. It radiates out into the vastness of interstellar space, wasted forever.
