...
% Title configuration
\title{The Tiny Book on the Governance of Machine}
...
\begin{center}
\vspace*{1cm}
{\Large\bfseries The Tiny Book on the Governance of Machine}
\vspace*{1cm}
\end{center}
...
Want a primer on AI? Start with \href{#a-crash-course-on-ai}{A Crash Course on AI}.

Already up to speed on AI and understand the risks? Jump straight to \href{#implicit-guardrails}{Implicit Guardrails}. 

Just want to read some new ideas in AI governance? Jump to \href{#rapid-fire-governance}{Rapid Fire Governance}.

Only have 30 seconds? Read the \href{#tl-dr}{AI Governance TL;DR}.

Or, fuck it, YOLO your way through the whole book.

\clearpage
\vspace*{1.5cm}
\section*{don t be silly}
\vspace{0.7cm}
...
This may seem like a small thing, but it s not. We shy away from talking seriously about serious things when we re afraid it makes us look silly. And it has real consequences.
...
\item Knowledge convection
    ...
    \item Conspiracies and cartels are hard today
    \begin{itemize}
    ...
    \item Limited power of committees
    \begin{itemize}
    ...
    \item Personal fear of reprisal
    \begin{itemize}
    ...
    \item The  Greg Brockman  problem
    \begin{itemize}
    ...
    \item Geopolitical interdependence
    \begin{itemize}
    ...
    \item There s general friction in visibility of what people are doing
    \begin{itemize}
    ...
    \item There s general friction in enforcement of laws \& regs
    \begin{itemize}
    ...
    \item Authorities need to act through human agents
    \begin{itemize}
    ...
    \item Limits to this; plenty of folks wanted to staff concentration camps
        ...
        \item In at least 2 cases (Cuban missile crisis + Petrov incident) one single human s moral compass is all that prevented a general nuclear exchange
    \item Culture is the final backstop 
    \end{itemize}
    
    \item Even dictators need their citizens
    \begin{itemize}
    \item With AI this will no longer be true 
    \end{itemize}
    
    \item Elite social pressure matters to many leaders
    \begin{itemize}
    ...
    \item In the final limit, citizens can revolt
    \begin{itemize}
    ...
    \item Humans have economic and strategic value
...
\clearpage
\vspace*{1.5cm}
\section*{Rapid Fire Governance}
\vspace{0.7cm}

\begin{fancyquote}
If we can YOLO research we can YOLO new forms of governance. lol. LFG [rock hand]
\end{fancyquote}
...
\clearpage
\vspace*{1.5cm}
\section*{An exponential, if you can keep it}
\vspace{0.7cm}
...
When we re afraid, when we re up against impossible odds, what we control is who we are. What we stand for. Stand for the good.
