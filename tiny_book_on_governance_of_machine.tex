...
\subsection*{Chapter 1: Why AI is accelerating, and why we have little time left}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 2: What do we want from our machines and governance?}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 3: The end of implicit guardrails}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 4: A simple path to tyranny}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 5: The Prompt of Power}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 6: Rapid fire governance --- designing upgrades to democracy}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 7: Superchecks and superbalances}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 8: The realpolitik AI --- forging a new political alliance}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Chapter 9: An exponential, if you can keep it}
\vspace{0.3cm}
...
\begin{fancyquote}
when will superintelligence emerge? let's take a guess. it's kind of like horse betting, but we die if we bet wrong
...
\item Flash forward to 2025, just two years later, and AIs can now routinely complete programming tasks that would take a human half an hour, sometimes more. These are hard, complex tasks, that sometimes some programmers can't even complete at all
...
\needspace{3\baselineskip}
\subsection*{Knowledge convection distributes power}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Information sharing creates accountability}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Humans prefer to support noble causes}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Top talent can vote with their feet}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Humans can refuse specific orders}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Whistleblowers limit egregious actions}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Conspiracies and cartels are hard to maintain}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Cronies are dumb, limiting their impact}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Media helps spread knowledge of malfeasance}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Social media spreads knowledge that mainstream may not }
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Limited power of committees}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Principal-agent problems stymie large organizations}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Community approval and self-approval influence human actions}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Personal fear of justice}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Judges and police officers have their own ethics}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{There's general friction in enforcement of laws and regulations}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Lack of internal competition can slow down big entities}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{The bread and circus isn't easy to maintain}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Leaders can't execute on their own}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Geopolitical interdependence disperses power}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{An army of the willing will only fight for certain causes}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{An interdependent corporate ecosystem disperses power}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Surveillance is hard}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Elite social pressure matters to many leaders}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{In the final limit, citizens can revolt}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Humans have economic and strategic value}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Even dictators need their citizens}
\vspace{0.3cm}
...
\needspace{3\baselineskip}
\subsection*{Replacing implicit guardrails with explicit design}
\vspace{0.3cm}
...
Share this book. Start a conversation. Read. Fight for good policies and standards, whether at work, for government, or in your community.
...
Humanity won. That is our heritage. We are the children and the grandchildren of those heroes. The heroes that averted war, averted disaster, delivered us the peace we've cherished for decades. 
