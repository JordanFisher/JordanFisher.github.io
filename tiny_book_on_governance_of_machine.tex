...
{\Large\bfseries Governing a Human-Machine Society}\\[1.5cm]
...
\clearpage
\vspace*{1.5cm}
\section*{A new user has joined the chat}
\vspace{0.7cm}
...
``Chapter 1: Why AI is accelerating, and why we have little time left'' on page~\pageref{why-ai-is-accelerating--and-why-we-have-little-time-left}
...
``Chapter 2: What do we want from our machines and governance?'' on page~\pageref{what-do-we-want-from-our-machines-and-governance-}
...
``Chapter 3: The end of implicit guardrails'' on page~\pageref{the-end-of-implicit-guardrails}
...
``Chapter 4: A simple path to tyranny'' on page~\pageref{a-simple-path-to-tyranny}
...
``Chapter 5: The Prompt of Power'' on page~\pageref{the-prompt-of-power}
...
``Chapter 6: Rapid fire governance --- designing upgrades to democracy'' on page~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}
...
``Chapter 7: Superchecks and superbalances'' on page~\pageref{superchecks-and-superbalances}
...
``Chapter 8: The realpolitik AI --- forging a new political alliance'' on page~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}
...
``An exponential, if you can keep it'' on page~\pageref{h-xedv3dcift3s}
...
For those looking for a primer on AI, we recommend starting with ``Chapter 10: A Crash Course on AI'' on page~\pageref{a-crash-course-on-ai}. For everyone else, I'll see you on the curve.

TABLEOFCONTENTS

\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 1:} Why AI is accelerating, and why we have little time left}\label{why-ai-is-accelerating--and-why-we-have-little-time-left}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 2:} What do we want from our machines and governance?}\label{what-do-we-want-from-our-machines-and-governance-}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 3:} The end of \sout{implicit} guardrails}\label{the-end-of-implicit-guardrails}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 4:} A simple path to tyranny}\label{a-simple-path-to-tyranny}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 5:} The Prompt of Power}\label{the-prompt-of-power}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 6:} Rapid fire governance --- designing upgrades to democracy}\label{rapid-fire-governance---designing-upgrades-to-democracy}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 7:} Superchecks and superbalances}\label{superchecks-and-superbalances}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 8:} The realpolitik AI --- forging a new political alliance}\label{the-realpolitik-ai---forging-a-new-political-alliance}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 9:} An exponential, if you can keep it}\label{an-exponential--if-you-can-keep-it}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 10:} A Crash Course on AI}\label{a-crash-course-on-ai}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 11:} don't be silly}\label{don-t-be-silly}
\vspace{0.7cm}
...
\clearpage
\vspace*{1.5cm}
\section*{\textit{Chapter 12:} Complexity and Iterative Design}\label{complexity-and-iterative-design}
\vspace{0.7cm}
