...
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 1} & {\sffamily\itshape pg.~\pageref{why-ai-is-accelerating--and-why-we-have-little-time-left}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Why AI is accelerating, and why we have little time left} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 2} & {\sffamily\itshape pg.~\pageref{what-do-we-want-from-our-machines-and-governance-}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape What do we want from our machines and governance?} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 3} & {\sffamily\itshape pg.~\pageref{the-end-of-implicit-guardrails}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The end of implicit guardrails} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 4} & {\sffamily\itshape pg.~\pageref{a-simple-path-to-tyranny}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape A simple path to tyranny} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 5} & {\sffamily\itshape pg.~\pageref{the-prompt-of-power}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The Prompt of Power} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 6} & {\sffamily\itshape pg.~\pageref{rapid-fire-governance---designing-upgrades-to-democracy}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Rapid fire governance — designing upgrades to democracy} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 7} & {\sffamily\itshape pg.~\pageref{superchecks-and-superbalances}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape Superchecks and superbalances} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 8} & {\sffamily\itshape pg.~\pageref{the-realpolitik-ai---forging-a-new-political-alliance}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape The realpolitik AI — forging a new political alliance} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 9} & {\sffamily\itshape pg.~\pageref{an-exponential--if-you-can-keep-it}} \\[0.3cm]
\nopagebreak
\multicolumn{2}{p{\textwidth}}{\Large\sffamily\itshape An exponential, if you can keep it} \\
\noalign{\vspace{2em}}
\nopagebreak
{\sffamily\itshape Chapter 10} & {\sffamily\itshape pg.~\pageref{a-crash-course-on-ai}} \\[0.3cm]
\nopagebreak
...
\item There is concern that once AI is smarter than humans, we will lose control of it. This is a real risk, and there are many discussions and efforts to prevent this
\item In our discussions here we will assume we've solved those risks, and that our AIs are aligned to their users. In that world, the biggest question that remains is how we should govern a human-machine society. We'll see that this may be the greatest challenge of our generation
\end{itemize}
...
\item In particular, once the full force of AI automation arrives, the risk of concentration of power and dictatorship will increase substantially
\end{itemize}
...
\item Even that we often don't know how to do, so we often \textit{train an AI to figure out how to give feedback to itself} in a process called RLHF. This may sound circuitous, but it's similar to how a coach can help a world class athlete becomes a better athlete, even if the coach themself isn't and never was world class
\end{itemize}
...
\item The Khmer Rouge killed nearly 25\% of their own population, crippling their own warmaking ability. Because of this mistake, they ended up obliterated by a Vietnamese invasion.
